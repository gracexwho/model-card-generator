...
from sklearn.decomposition import PCAfrom sklearn.svm import SVCfrom sklearn.linear_model import LogisticRegressionfrom sklearn.naive_bayes import MultinomialNB
 ```
### values ###
"n_components,whiten,svd_solverkernel,degree,gamma,shrinking,probability,tolpenalty,dual,tol,C,fit_intercept,class_weight,solver,multi_classalpha,fit_prior"
### description ###
